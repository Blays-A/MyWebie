...
const Intermediatebox = () => {
    ...
    return (
        <div>
            <div style={boxStyle}>
                <h1>Intermediate</h1>
                <p>Спорь с иностранцем, езжай в путешествие без гида! Уровень intermediate подходит для учащихся, которые имеют базовые знания английского языка и готовы к более глубокому изучению. На этом уровне студенты могут уверенно общаться на простых темах и понимать основное содержание текстов. Они могут составлять сложные предложения, хотя иногда допускают ошибки. Студенты на уровне intermediate способны читать и анализировать более сложные тексты на английском языке и составлять свои собственные тексты на различные темы. Обучение на этом уровне направлено на развитие навыков общения и углубление понимания языковых структур.</p>
            </div>
