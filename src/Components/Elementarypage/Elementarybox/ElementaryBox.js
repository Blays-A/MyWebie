...
const ElementaryBox = () => {
    ...
    return (
        ...
        <div style={boxStyle}>
            <h1>ELEMENTARY</h1>
            <p className="descript_level">На уровне elementary студенты начинают свой путь в изучении английского языка. Они осваивают базовые языковые концепции, такие как алфавит, простые фразы и основные грамматические правила. Учащиеся начинают понимать простые разговорные выражения и могут общаться на простых темах, таких как семья, хобби и повседневная рутина. Кроме того, они начинают развивать навыки чтения и письма, составляя простые тексты и читая короткие истории или статьи. Обучение на уровне elementary направлено на создание прочной основы для дальнейшего изучения языка, обеспечивая студентам уверенность в использовании английского языка в повседневных ситуациях.
